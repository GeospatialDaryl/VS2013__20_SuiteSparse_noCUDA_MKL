...
!   ACML version 6.0 Copyright AMD 2014
...
!      .. Parameters ..
       ...
       REAL (KIND=SP), PARAMETER       :: ALIM = -1.0E0_SP
       REAL (KIND=SP), PARAMETER       :: BLIM = 1.0E0_SP
...
!      .. Parameters ..
       ...
       INTEGER, PARAMETER              :: WP=KIND(0.0D0)
!      .. Scalar Arguments ..
       REAL (KIND=SP)                  :: ALIM, ALPHA, BETA, BLIM
       INTEGER                         :: K, M, N
       CHARACTER (1)                   :: TRANSA, TRANSB
!      .. Local Scalars ..
...
!      .. Local Arrays ..
       REAL (KIND=SP), ALLOCATABLE     :: A(:,:), B(:,:), C(:,:)
!      .. External Functions ..
       REAL (KIND=WP), EXTERNAL        :: DSECND
!      .. External Subroutines ..
       EXTERNAL                           SGEMM, RANDMAT
!      .. Intrinsic Functions ..
       INTRINSIC                          REAL
!      .. Executable Statements ..
       CONTINUE
...
!         Number of MFLOPs in a SGEMM of size M-by-K-by-N:
...
!      .. Scalar Arguments ..
       REAL (KIND=SP)                  :: ALIM, BLIM
       INTEGER                         :: LDA, M, N
!      .. Array Arguments ..
       REAL (KIND=SP)                  :: A(LDA,N)
!      .. Local Scalars ..
...
!         Generate a matrix from a uniform U(ALIM,BLIM) distribution
          CALL SRANDUNIFORM(M,ALIM,BLIM,STATE,A(1,I),INFO)
       END DO
